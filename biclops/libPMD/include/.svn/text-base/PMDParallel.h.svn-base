...
private:
    ...
    static PMDuint16 InP16Bit(PMDuint16 port) {return 0;} //{return _inpw(port);};
...
//	    _outp(port, (PMDuint8)dataword&0xFF);
    ...
    static PMDuint16 InP8Bit(PMDuint16 port) {return 0;}; //{return (PMDuint16) (((_inp(port) & 0xFF) << 8) | (_inp(port) & 0xFF));};
    static void OutP8BitCmd(PMDuint16 port, PMDuint16 dataword) {}; //{_outp(port, (PMDuint8)dataword&0xFF);};
    static PMDuint16 InP8BitStatus(PMDuint16 port) {return 0;}; //{return (PMDuint16)(_inp(port) & 0xFF);};
#else
