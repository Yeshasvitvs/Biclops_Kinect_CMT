...
double Length(double V1, double V2, double V3, double V4, double V5, double V6, double V7);
double Length(pVec2_t Vin); // checked in MathTest.cpp
double Length(pVec3_t Vin); // checked in MathTest.cpp
double Length(pVec7_t Vin);
...
pVec7_t Add_v(pVec7_t V1in, pVec7_t V2in, pVec7_t Vout);
...
pVec7_t Sub_v(pVec7_t V1in, pVec7_t V2in, pVec7_t Vout);
...
pVec7_t Mult_sv(double s, pVec7_t Vin, pVec7_t Vout);
...
bool UnitVector(pVec7_t Vin, pVec7_t Vout, double *R);
...
void LoadVec3FromFile(FILE* apF, pVec3_t apV, bool abgarb = false);
